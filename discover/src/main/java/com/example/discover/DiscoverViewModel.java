...
public class DiscoverViewModel extends ViewModel {
    ...
    private MutableLiveData<ResponseData<PictureData>> _DiscoverPicList = new MutableLiveData<>();
    public LiveData<ResponseData<PictureData>> discoverPicList = _DiscoverPicList;
    ...
    public void getDiscoverPicList(int current, int size, long userId){
        retrofitService.getPictureListOfShare(current, size, userId).enqueue(new Callback<RetrofitResponse<ResponseData<PictureData>>>() {
            ...
            public void onResponse(@NonNull Call<RetrofitResponse<ResponseData<PictureData>>> call, @NonNull Response<RetrofitResponse<ResponseData<PictureData>>> response) {
                ...
                _DiscoverPicList.setValue(responseBody.data);
