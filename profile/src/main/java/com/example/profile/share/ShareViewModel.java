...
public class ShareViewModel  extends ViewModel {
    ...
    public void getShareList(int current, int size, long userId){
        retrofitService.getPictureListOfCurrentShare(current, size, userId).enqueue(new Callback<RetrofitResponse<ResponseData<PictureData>>>() {
            @Override
            public void onResponse(@NonNull Call<RetrofitResponse<ResponseData<PictureData>>> call, @NonNull Response<RetrofitResponse<ResponseData<PictureData>>> response) {
                ...
                _sharePicList.setValue(responseBody.data);
